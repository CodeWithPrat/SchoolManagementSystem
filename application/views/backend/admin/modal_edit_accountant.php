                    ...
                    <?php echo form_open(base_url() . 'index.php?admin/accountant/do_update/'.$row['accountant_id'] , array('class' => 'form-horizontal form-groups-bordered validate','target'=>'_top', 'enctype' => 'multipart/form-data'));?>
                        <div class="padded">
                            ...
                            <div class="form-group">
                                ...
                                <div class="controls" style="width:210px;">
                                    <img id="blah" src="<?php echo $this->crud_model->get_image_url('accountant',$row['accountant_id']);?>" alt="your image" height="100" />
                                </div>
                            </div>
                        </div>
                        <div class="form-actions">
                            <button type="submit" class="btn btn-info"><i class="fa fa-save"></i><?php echo get_phrase('edit_accountant');?></button>
                        </div>
                    </form>
                    <?php endforeach;?>
                </div>
